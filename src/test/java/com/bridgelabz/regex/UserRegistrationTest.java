...
public class UserRegistrationTest {
	...
	public void test_firstName_Cases() {
		List<Boolean> result = firstNameTestCases.apply(Arrays.asList("Bhuwan"));
	...
	public void test_lastName_Cases() {
		List<Boolean> result = lastNameTestCases.apply(Arrays.asList("Arya"));
		List<Boolean> expected = Arrays.asList(true);
		assertEquals(expected, result);
	}
	...
	public void test_phoneNumber_Cases() {
		List<Boolean> result = phoneTestCases.apply(Arrays.asList("91 8426023224"));
		List<Boolean> expected = Arrays.asList(true);
		assertEquals(expected, result);
	}
	...
	public void test_password_Cases() {
		List<Boolean> result = passwordTestCases.apply(Arrays.asList("Bhuwan@1995"));
		List<Boolean> expected = Arrays.asList(true);
		assertEquals(expected, result);
	}
}